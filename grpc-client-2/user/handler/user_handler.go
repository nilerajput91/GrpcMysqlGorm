...
import (
	...
	"github.com/nilerajput91/RPc/grpc-client-2/utils"
)
...
func (e *UserHandler) addUser(c *gin.Context) {
	...
	utils.HandleSuccess(c, "Successfully added  data into Db")
}
...
func (e *UserHandler) UpdateUser(c *gin.Context) {
	...
	utils.HandleSuccess(c, "UpdateUser successfully")
}
...
func (e *UserHandler) deleteUser(c *gin.Context) {
	...
	utils.HandleSuccess(c, "Data Deleted successfully")
}
